<%@ Page Title="" Language="C#" MasterPageFile="~/Casos.master" AutoEventWireup="true" CodeBehind="ConsultarCaso.aspx.cs" Inherits="BugTracker.ConsultarCaso" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp;&nbsp; Codigo del Caso&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownList8" runat="server" DataSourceID="SqlDataSource1" DataTextField="CodigoCaso" DataValueField="CodigoCaso">
        </asp:DropDownList>
...
&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp; Nombre del Proyecto:&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox1" runat="server" Width="215px" Enabled="False"></asp:TextBox>
        &nbsp;<br />
&nbsp;&nbsp;&nbsp;
        <br />
&nbsp;&nbsp;&nbsp; Estado&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp; Situacion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        ...
        <br />
&nbsp;&nbsp;&nbsp; Prioridad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:DropDownList ID="DropDownList1" runat="server" Enabled="False">
            <asp:ListItem></asp:ListItem>
...
&nbsp;&nbsp;&nbsp; 
        <br />
        &nbsp;&nbsp;&nbsp; Fecha de Entrega <asp:DropDownList ID="DropDownList2" runat="server" Enabled="False">
            <asp:ListItem></asp:ListItem>
...
&nbsp;<asp:DropDownList ID="DropDownList4" runat="server" Enabled="False" >
        ...
        <br />
&nbsp;&nbsp;&nbsp; Categoria``<asp:DropDownList ID="DropDownList5" runat="server" Enabled="False">
            <asp:ListItem></asp:ListItem>
...
&nbsp;&nbsp;&nbsp; Descripcion:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
&nbsp;<asp:TextBox ID="TextBox5"  TextMode="MultiLine" runat="server" Height="109px" Width="302px" Enabled="False"></asp:TextBox>
        <br />
        &nbsp;&nbsp;&nbsp;
        <br />
        <br />
